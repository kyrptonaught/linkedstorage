    ...
    public static void registerReceivePacket() {
        ServerSidePacketRegistry.INSTANCE.register(OPEN_STORAGE_PACKET, (packetContext, packetByteBuf) -> {
            ...
            packetContext.getTaskQueue().execute(() -> {
                ...
                ContainerProviderRegistry.INSTANCE.openContainer(new Identifier(LinkedStorageMod.MOD_ID, "linkedstorage"), packetContext.getPlayer(), (buf) -> buf.writeIntArray(LinkedInventoryHelper.getBlockChannel(world, pos)));
            });
        });
    }
